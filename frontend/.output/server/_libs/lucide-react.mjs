...
const Church = createLucideIcon("church", __iconNode$t);
const __iconNode$s = [
...
const Music4 = createLucideIcon("music-4", __iconNode$e);
const __iconNode$d = [
...
const StarHalf = createLucideIcon("star-half", __iconNode$7);
const __iconNode$6 = [
  [
    "path",
    {
