...
import { f as fetchTracks, a as fetchRatings, b as fetchMyRatings, c as categoryLabel, r as rateTrack } from "./audio-DIfY7T1V.mjs";
import { u as useAuth } from "./useAuth-BQb4fGeE.mjs";
import { S as Sparkles, A as ArrowRight, M as Megaphone, C as Church, L as Languages, H as Headphones, a as ShieldCheck, Z as Zap, E as Earth, b as Check, c as ArrowLeft, X, D as DollarSign, P as Pause, d as Play, e as Download, f as Star, g as StarHalf } from "../_libs/lucide-react.mjs";
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              playingId === t.id && audioUrls[t.id] && /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { src: audioUrls[t.id], controls: true, autoPlay: true, className: "w-full" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "py-20 md:py-28 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-3xl mx-auto px-4 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-10 grid gap-4 max-w-md mx-auto text-left", onSubmit: (e) => e.preventDefault(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "name", name: "name", required: true, maxLength: 100, className: "px-5 py-3.5 rounded-xl glass bg-input/40 outline-none focus:border-gold/60 transition placeholder:text-muted-foreground", placeholder: "Your full name" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "email", name: "email", type: "email", required: true, maxLength: 255, className: "px-5 py-3.5 rounded-xl glass bg-input/40 outline-none focus:border-gold/60 transition placeholder:text-muted-foreground", placeholder: "you@company.com" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { id: "message", name: "message", rows: 4, required: true, maxLength: 1e3, className: "px-5 py-3.5 rounded-xl glass bg-input/40 outline-none focus:border-gold/60 transition placeholder:text-muted-foreground resize-none", placeholder: "What kind of audio do you need?" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "mt-2 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gold-gradient text-primary-foreground font-semibold shadow-gold hover:scale-[1.01] transition", children: [
            "Request a Demo ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4" })
          ] })
        ] }),
