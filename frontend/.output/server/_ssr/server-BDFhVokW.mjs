...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D7SPueJF.mjs");
...
const manifest = {
  "89ff173fbe56a8ca331e9ac50d31ad63f4a7c5acc7e881bde011b8bacae2fd8f": {
    ...
    importer: () => import("./audio.functions-BTXkIcYf.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dgc55Kgt.mjs"),
    import("./start-BWjWdnmg.mjs"),
