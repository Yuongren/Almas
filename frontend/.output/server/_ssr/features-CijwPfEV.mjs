...
function FeaturesPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-4", children: features.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group p-6 rounded-2xl glass shadow-card hover:-translate-y-1 hover:shadow-gold transition-all", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 md:py-24 bg-card/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-10 grid md:grid-cols-3 gap-4", children: why.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "p-6 rounded-2xl glass", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 rounded-xl glass grid place-items-center text-gold mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(f.i, { className: "h-5 w-5" }) }),
