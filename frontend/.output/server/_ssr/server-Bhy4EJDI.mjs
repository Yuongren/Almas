...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cwu3w8M8.mjs");
...
const manifest = {
  "89ff173fbe56a8ca331e9ac50d31ad63f4a7c5acc7e881bde011b8bacae2fd8f": {
    functionName: "uploadAudioTrack_createServerFn_handler",
    importer: () => import("./audio.functions-BfONi0w9.mjs")
  },
  "a8ea96f55c98d9dfe39eba1f21271c6c33bfa924611fe9d828fca0774e41b939": {
    functionName: "getGreeting_createServerFn_handler",
    importer: () => import("./example.functions-CXcFHnVD.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B_L4t2RU.mjs"),
    import("./start-o4LCdYBU.mjs"),
